...
ActiveRecord::Schema[7.0].define(version: 2022_02_17_084100) do
  create_table "companies", primary_key: "code", id: { type: :string, limit: 8 }, charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "countries", primary_key: "code", id: { type: :string, limit: 4 }, charset: "utf8mb4", force: :cascade do |t|
    t.string "name", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "currencies", primary_key: "code", id: { type: :string, limit: 4 }, charset: "utf8mb4", force: :cascade do |t|
    t.string "name", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "payment_methods", primary_key: "code", id: { type: :string, limit: 36 }, charset: "utf8mb4", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "payment_options", charset: "utf8mb4", force: :cascade do |t|
    t.string "currency_code", limit: 4, null: false
  ...
  create_table "pricing_settings", charset: "utf8mb4", force: :cascade do |t|
